document.getElementById('loginForm').addEventListener('submit', function(event) {
  ...
  // Daftar NAMA yang sudah ditentukan dengan nama
  const validNameList = {
      "tes" :  "Abyakta",
      "24011802" :  "Adhhira",
      "24011803" :  "Ahmad",
  ...
  // Cek apakah NAMA yang dimasukkan ada di dalam daftar
  if (validNameList[nameInput]) {
    // Login berhasil dan loading
      userName = validNameList[nameInput];
      ...
      setTimeout(function() {
        const userName = validNameList[nameInput];
    ...
    document.getElementById('errorMessage').textContent = 'NAMA tidak valid atau belum terdaftar';
  }
});